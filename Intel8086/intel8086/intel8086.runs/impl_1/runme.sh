...
HD_PWD='D:/facultate/an 3/sem 1/SSC/proiect/intel8086/intel8086.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log intel8086.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source intel8086.tcl -notrace
