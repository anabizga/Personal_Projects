...
HD_PWD='D:/facultate/an 3/sem 1/SSC/proiect/intel8086/intel8086.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log intel8086.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source intel8086.tcl
